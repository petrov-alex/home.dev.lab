    ...
    internal class CaptionButton : Component, INotifyPropertyChanged
    {
        ...
        public Rectangle Bounds
        {
            ...
            set
            {
                ...
                _bounds = value;
                PropertyChangedEventArgs e = new PropertyChangedEventArgs(nameof(Bounds));
                OnPropertyChanged(e);
            }
        }
        ...
        public bool Hovered
        {
            ...
            set
            {
                ...
                _hovered = value;
                PropertyChangedEventArgs e = new PropertyChangedEventArgs(nameof(Hovered));
                OnPropertyChanged(e);
            }
        }
        ...
        public bool Pressed
        {
            ...
            set
            {
                ...
                _pressed = value;
                PropertyChangedEventArgs e = new PropertyChangedEventArgs(nameof(Pressed));
                OnPropertyChanged(e);
            }
        }
        ...
        public bool Enabled
        {
            ...
            set
            {
                ...
                _enabled = value;
                PropertyChangedEventArgs e = new PropertyChangedEventArgs(nameof(Enabled));
                OnPropertyChanged(e);
            }
        }
